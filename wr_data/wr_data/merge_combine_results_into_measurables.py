...
MEASURABLES_FILE = SCRIPT_DIR / "my_players_with_measurables.csv"
MATCH_REPORT_FILE = SCRIPT_DIR / "combine_measurable_match_report.csv"
UNMATCHED_TARGET_FILE = SCRIPT_DIR / "combine_measurable_unmatched_targets.csv"
UNUSED_SOURCE_FILE = SCRIPT_DIR / "combine_measurable_unused_source_rows.csv"
...
def load_combine_sources(script_dir):
...
def main():
    ...
    source_df = load_combine_sources(SCRIPT_DIR)
