...
PREDICTIONS_FILE = SCRIPT_DIR / f"wr_holdout_{HOLDOUT_YEAR}_predictions_3.csv"

def get_latest_fantasy_year(script_dir=SCRIPT_DIR):
    latest_year = None
    for file_path in script_dir.glob("FantasyPros_Fantasy_Football_Statistics_*.csv"):
