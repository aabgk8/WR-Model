...
MODEL_FILE = SCRIPT_DIR / "rf_binary_600yd_first2yrs.joblib"
HOLDOUT_PREDICTIONS_FILE = SCRIPT_DIR / "wr_holdout_2025_binary_600yd_first2yrs_predictions.csv"
BACKTEST_FILE = SCRIPT_DIR / "wr_binary_600yd_first2yrs_backtest.csv"
FEATURE_IMPORTANCE_FILE = SCRIPT_DIR / "wr_binary_600yd_first2yrs_feature_importance.csv"
...
def main():
    ...
    base.print_metrics(
        "Random split validation (600 receiving yards within 2 years)",
    ...
    X_full, final_imputer = base.prepare_feature_matrix(complete_train_df, feature_cols, fit_imputer=True)
