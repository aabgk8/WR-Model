...
def main():
    ...
    features_file = script_dir / "wr_te_final_with_fantasy.csv"
    draft_file = script_dir / "2025-2014_receiver_draft_orders.csv"
    ...
    match_report_file = script_dir / "draft_order_match_report.csv"
    match_report.to_csv(match_report_file, index=False)

    unmatched_file = script_dir / "draft_order_unmatched.csv"
