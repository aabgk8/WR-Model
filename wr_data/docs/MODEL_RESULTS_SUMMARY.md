...
- Scripts live in `wr_data/`
- Raw inputs live under `wr_data/data/raw/`
- Processed tables live under `wr_data/data/processed/`
- Published result CSVs live under `wr_data/outputs/`
