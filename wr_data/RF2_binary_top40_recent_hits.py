...
MODEL_FILE = paths.MODELS_DIR / "rf_binary_top40_within3yrs_recent_hits.joblib"
HOLDOUT_PREDICTIONS_FILE = (
    paths.PREDICTIONS_DIR / "wr_holdout_2025_binary_top40_within3yrs_recent_hits_predictions.csv"
)
BACKTEST_FILE = paths.BACKTESTS_DIR / "wr_binary_top40_within3yrs_recent_hits_backtest.csv"
FEATURE_IMPORTANCE_FILE = (
    paths.FEATURE_IMPORTANCE_DIR / "wr_binary_top40_within3yrs_recent_hits_feature_importance.csv"
)
